...
const PointsStreamFactory = new StreamFactoryBuilder("PointsStream")
  .withEvent("PointsAdded").asType<PointsAdded>().withMessages(pointsAddedMessages)
  .withEvent("PointsSubtracted").asType<PointsSubtracted>()
  .withEvent("PointsMultiplied").asType<PointsMultiplied>().withMessages(pointsMultipliedMessages)
